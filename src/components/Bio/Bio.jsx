...
function Bio(props) {
  ...
  const [userAboutValue, setUserAboutValue] = useState("||React||");

  //Use Effect Hook for calling from Image from dataBase
  useEffect(() => {
    const setDataFromDb = async () => {
      // const newProfilePhotoFromDb = await db.bio.get("profilePhoto");
      // newProfilePhotoFromDb && setProfileImage(newProfilePhotoFromDb);
